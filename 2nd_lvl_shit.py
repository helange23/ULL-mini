...
def trainModels(k=100):
    ...
    pickle.dump(leftval0,open('2lval0'+str(k),'wb'))
    pickle.dump(rightval0,open('2rval0'+str(k),'wb'))
    ...
    pickle.dump(rep_vecs,open('2nnrep_model'+str(k),'wb'))
    print 'Done'
